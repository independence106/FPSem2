...
public class PlayerFireball extends Entity {

    public PlayerFireball(double x, double y){
        this.width = 30;
        this.height = 30;
        this.xPos = x;
        this.yPos = y;
    ...
    public PlayerFireball(double x, double y, double targetX, double targetY) {
        this.width = 30;
        this.height = 30;
        this.xPos = x;
        this.yPos = y;
    ...
    public void tick(Level level) {
        ...
        for (int i = 0; i < level.levMap.rigidBlocks.size(); i++) {
            if (getBounds().intersects(level.levMap.rigidBlocks.get(i).getBounds())){
